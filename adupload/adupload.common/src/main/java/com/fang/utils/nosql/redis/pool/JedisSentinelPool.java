...
public final class JedisSentinelPool extends JedisPool {
   ...
   * @param masterName
   *        One sentinel can monitor several redis master-slave pair, use master name to identify
   *        them.
  ...
  public class MasterSwitchListener extends Thread {
      ...
      while (running.get()) {
        try {
          ...
          if (sentinelPool != null) {
            ...
            // When the system startup but the sentinels not yet, init a urgly address to prevent
            // null point
    ...
    private class MasterSwitchSubscriber extends JedisPubSub {
      ...
      public void onMessage(String channel, String message) {
        ...
        // +redirect-to-master default 127.0.0.1 6380 127.0.0.1 6381 (if slave-master fail-over
        // quick enough)
