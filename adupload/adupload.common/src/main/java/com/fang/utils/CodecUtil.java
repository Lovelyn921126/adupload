...
public class CodecUtil {
  ...
  public static String urlEncode(String part) {
    try {
      return URLEncoder.encode(part, CharsetsUtil.UTF_8);
  ...
  public static String urlDecode(String part) {
    ...
    try {
      return URLDecoder.decode(part, CharsetsUtil.UTF_8);
    } catch (UnsupportedEncodingException e) {
      throw ExceptionUtil.unchecked(e);
    }
  }
   ...
   * @return 转码后的字符串
   */
  public static String toHex(String input, String enc) {
    try {
      byte[] data = input.getBytes(enc);
